...
#
# Generated by export_simulation on Wed Apr 19 16:55:56 -0700 2023
#
################################################################################
...
'-reset_run' switch to the './BlockDesignArtyS7.sh' script.

./BlockDesignArtyS7.sh -reset_run
...
./BlockDesignArtyS7.sh -noclean_files

For more information on the script, please type './BlockDesignArtyS7.sh -help'.
